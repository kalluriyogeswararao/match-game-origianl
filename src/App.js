...
const ImageItem = props => {
  const {imageitem, selectImage} = props
...
class App extends Component {
  ...
  navBar = () => {
    ...
    return (
      <nav className="navbar">
        <img src={GAME_LOGO} alt="website logo" className="web-logo" />
        ...
        <div className="score-details">
          ...
          <img
            ...
            className="timer"
          />
          <p className="span">{countDown} Sec</p>
        </div>
      </nav>
    )
  }
  ...
  selectImage = id => {
    ...
    const index = Math.ceil(Math.random() * 29)

    if (randomImage.id === id) {
      const random = imagesList[index]
  ...
  displayRandomImage = () => {
    ...
    return <img src={imageUrl} alt="match" className="random-image" />
  }

  playAgain = () => {
    this.setState({gameStatus: true, score: 0})
  }
  ...
  gameOverPage = () => {
    ...
    return (
      <div className="game-over">
        <h1 className="score-data">Your Score</h1>
  ...
  render() {
    ...
    const filterImages = this.filteredImages()
    return (
      <div className="bg-container">
        ...
        {gameStatus && (
          <div className="tab-details">
            ...
            {this.allTabsDisplay()}
            {this.allImagesDisplay(filterImages)}
          </div>
        )}
        <div className="game-page">{!gameStatus && this.gameOverPage()}</div>
      </div>
    )
  }
}
